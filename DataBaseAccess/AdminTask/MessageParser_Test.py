...
def testFaultyStartByte():
	c_msg = (0x81, 0x6+1, 0x0, 0x81, 0xA1, 0x81, 0xA0, 0x1, 0x2, 0x3, 0x4)
...
def testFaultyMsgType():
	c_msg = (0x80, 0x6+1, 0x5, 0x81, 0xA1, 0x81, 0xA0, 0x1, 0x2, 0x3, 0x4)
...
def testStartByteWithoutEscape():
	c_msg = (0x80, 0x6+1, 0x0, 0x80, 0x81)
...
def testMisuedEscape():
	c_msg = (0x80, 0x6+1, 0x0, 0x81, 0x81)
